...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{namespacenlohmann_1_1detail_a909603fdded0b72729c7b16765d47e93}\label{namespacenlohmann_1_1detail_a909603fdded0b72729c7b16765d47e93}} 
using \mbox{\hyperlink{namespacenlohmann_1_1detail_a909603fdded0b72729c7b16765d47e93}{input\+\_\+adapter\+\_\+t}} = std\+::shared\+\_\+ptr$<$ \mbox{\hyperlink{structnlohmann_1_1detail_1_1input__adapter__protocol}{input\+\_\+adapter\+\_\+protocol}} $>$
...
{\footnotesize template$<$typename T , typename Integer $>$ }\\using {\bfseries number\+\_\+integer\+\_\+function\+\_\+t} = decltype(std\+::declval$<$ T \& $>$().\mbox{\hyperlink{classnumber__integer}{number\+\_\+integer}}(std\+::declval$<$ Integer $>$()))
\item 
...
{\footnotesize template$<$typename T , typename Unsigned $>$ }\\using {\bfseries number\+\_\+unsigned\+\_\+function\+\_\+t} = decltype(std\+::declval$<$ T \& $>$().\mbox{\hyperlink{classnumber__unsigned}{number\+\_\+unsigned}}(std\+::declval$<$ Unsigned $>$()))
\item 
...
{\footnotesize template$<$typename T , typename Float , typename String $>$ }\\using {\bfseries number\+\_\+float\+\_\+function\+\_\+t} = decltype(std\+::declval$<$ T \& $>$().\mbox{\hyperlink{classnumber__float}{number\+\_\+float}}(std\+::declval$<$ Float $>$(), std\+::declval$<$ const String \& $>$()))
\item 
...
{\footnotesize template$<$typename T , typename String $>$ }\\using {\bfseries string\+\_\+function\+\_\+t} = decltype(std\+::declval$<$ T \& $>$().\mbox{\hyperlink{classstring}{string}}(std\+::declval$<$ String \& $>$()))
\item 
...
enum \mbox{\hyperlink{namespacenlohmann_1_1detail_a5a76b60b26dc8c47256a996d18d967df}{error\+\_\+handler\+\_\+t}} \{ \newline
\mbox{\hyperlink{namespacenlohmann_1_1detail_a5a76b60b26dc8c47256a996d18d967dfa2133fd717402a7966ee88d06f9e0b792}{error\+\_\+handler\+\_\+t\+::strict}}, 
...
\item 
{\footnotesize template$<$typename Float\+Type $>$ }\\J\+S\+O\+N\+\_\+\+H\+E\+D\+L\+E\+Y\+\_\+\+R\+E\+T\+U\+R\+N\+S\+\_\+\+N\+O\+N\+\_\+\+N\+U\+LL char $\ast$ \mbox{\hyperlink{namespacenlohmann_1_1detail_a4ceeb4ec7f2cd493dd9cf328044c1e3c}{to\+\_\+chars}} (char $\ast$first, const char $\ast$last, Float\+Type value)
...
\begin{DoxyCode}{0}
\DoxyCodeLine{35 \{}
\DoxyCodeLine{36     \mbox{\hyperlink{namespacenlohmann_1_1detail_a5a76b60b26dc8c47256a996d18d967dfa2133fd717402a7966ee88d06f9e0b792}{strict}},  }
\DoxyCodeLine{37     \mbox{\hyperlink{namespacenlohmann_1_1detail_a5a76b60b26dc8c47256a996d18d967dfa9dde360102c103867bd2f45872f1129c}{replace}}, }
\DoxyCodeLine{38     \mbox{\hyperlink{namespacenlohmann_1_1detail_a5a76b60b26dc8c47256a996d18d967dfa567bc1d268f135496de3d5b946b691f3}{ignore}}   }
\DoxyCodeLine{39 \};}
...
Definition at line 41 of file value\+\_\+t.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{41                    : std::uint8\_t}
\DoxyCodeLine{42 \{}
\DoxyCodeLine{43     \textcolor{keyword}{null},             }
\DoxyCodeLine{44     \mbox{\hyperlink{classobject}{object}},           }
\DoxyCodeLine{45     \mbox{\hyperlink{classarray}{array}},            }
\DoxyCodeLine{46     \mbox{\hyperlink{classstring}{string}},           }
\DoxyCodeLine{47     \mbox{\hyperlink{namespacenlohmann_1_1detail_a1ed8fc6239da25abcaf681d30ace4985a84e2c64f38f78ba3ea5c905ab5a2da27}{boolean}},          }
\DoxyCodeLine{48     \mbox{\hyperlink{classnumber__integer}{number\_integer}},   }
\DoxyCodeLine{49     \mbox{\hyperlink{classnumber__unsigned}{number\_unsigned}},  }
\DoxyCodeLine{50     \mbox{\hyperlink{classnumber__float}{number\_float}},     }
\DoxyCodeLine{51     \mbox{\hyperlink{namespacenlohmann_1_1detail_a1ed8fc6239da25abcaf681d30ace4985a94708897ec9db8647dfe695714c98e46}{discarded}}         }
\DoxyCodeLine{52 \};}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{2854                    : std::uint8\_t}
\DoxyCodeLine{2855 \{}
\DoxyCodeLine{2856     \textcolor{keyword}{null},             }
\DoxyCodeLine{2857     \mbox{\hyperlink{classobject}{object}},           }
\DoxyCodeLine{2858     \mbox{\hyperlink{classarray}{array}},            }
\DoxyCodeLine{2859     \mbox{\hyperlink{classstring}{string}},           }
...
\DoxyCodeLine{2861     \mbox{\hyperlink{classnumber__integer}{number\_integer}},   }
\DoxyCodeLine{2862     \mbox{\hyperlink{classnumber__unsigned}{number\_unsigned}},  }
\DoxyCodeLine{2863     \mbox{\hyperlink{classnumber__float}{number\_float}},     }
...
Definition at line 64 of file value\+\_\+t.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{65 \{}
\DoxyCodeLine{66     \textcolor{keyword}{static} constexpr std::array<std::uint8\_t, 8> order = \{\{}
\DoxyCodeLine{67             0 \textcolor{comment}{/* null */}, 3 \textcolor{comment}{/* object */}, 4 \textcolor{comment}{/* array */}, 5 \textcolor{comment}{/* string */},}
\DoxyCodeLine{68             1 \textcolor{comment}{/* boolean */}, 2 \textcolor{comment}{/* integer */}, 2 \textcolor{comment}{/* unsigned */}, 2 \textcolor{comment}{/* float */}}
\DoxyCodeLine{69         \}}
\DoxyCodeLine{70     \};}
\DoxyCodeLine{71 }
\DoxyCodeLine{72     \textcolor{keyword}{const} \textcolor{keyword}{auto} l\_index = \textcolor{keyword}{static\_cast<}std::size\_t\textcolor{keyword}{>}(lhs);}
\DoxyCodeLine{73     \textcolor{keyword}{const} \textcolor{keyword}{auto} r\_index = \textcolor{keyword}{static\_cast<}std::size\_t\textcolor{keyword}{>}(rhs);}
\DoxyCodeLine{74     \textcolor{keywordflow}{return} l\_index < order.size() and r\_index < order.size() and order[l\_index] < order[r\_index];}
\DoxyCodeLine{75 \}}
...
Definition at line 1060 of file to\+\_\+chars.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{1061 \{}
\DoxyCodeLine{1062     \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{void}\textcolor{keyword}{>}(last); \textcolor{comment}{// maybe unused -\/ fix warning}}
\DoxyCodeLine{1063     assert(std::isfinite(value));}
\DoxyCodeLine{1064 }
\DoxyCodeLine{1065     \textcolor{comment}{// Use signbit(value) instead of (value < 0) since signbit works for -\/0.}}
\DoxyCodeLine{1066     \textcolor{keywordflow}{if} (std::signbit(value))}
\DoxyCodeLine{1067     \{}
\DoxyCodeLine{1068         value = -\/value;}
\DoxyCodeLine{1069         *first++ = \textcolor{charliteral}{'-\/'};}
\DoxyCodeLine{1070     \}}
\DoxyCodeLine{1071 }
\DoxyCodeLine{1072     \textcolor{keywordflow}{if} (value == 0) \textcolor{comment}{// +-\/0}}
\DoxyCodeLine{1073     \{}
\DoxyCodeLine{1074         *first++ = \textcolor{charliteral}{'0'};}
\DoxyCodeLine{1075         \textcolor{comment}{// Make it look like a floating-\/point number (\#362, \#378)}}
\DoxyCodeLine{1076         *first++ = \textcolor{charliteral}{'.'};}
\DoxyCodeLine{1077         *first++ = \textcolor{charliteral}{'0'};}
\DoxyCodeLine{1078         \textcolor{keywordflow}{return} first;}
\DoxyCodeLine{1079     \}}
\DoxyCodeLine{1080 }
\DoxyCodeLine{1081     assert(last -\/ first >= std::numeric\_limits<FloatType>::max\_digits10);}
\DoxyCodeLine{1082 }
\DoxyCodeLine{1083     \textcolor{comment}{// Compute v = buffer * 10\string^decimal\_exponent.}}
\DoxyCodeLine{1084     \textcolor{comment}{// The decimal digits are stored in the buffer, which needs to be interpreted}}
\DoxyCodeLine{1085     \textcolor{comment}{// as an unsigned decimal integer.}}
\DoxyCodeLine{1086     \textcolor{comment}{// len is the length of the buffer, i.e. the number of decimal digits.}}
\DoxyCodeLine{1087     \textcolor{keywordtype}{int} len = 0;}
\DoxyCodeLine{1088     \textcolor{keywordtype}{int} decimal\_exponent = 0;}
\DoxyCodeLine{1089     dtoa\_impl::grisu2(first, len, decimal\_exponent, value);}
\DoxyCodeLine{1090 }
\DoxyCodeLine{1091     assert(len <= std::numeric\_limits<FloatType>::max\_digits10);}
\DoxyCodeLine{1092 }
\DoxyCodeLine{1093     \textcolor{comment}{// Format the buffer like printf("\%.*g", prec, value)}}
\DoxyCodeLine{1094     constexpr \textcolor{keywordtype}{int} kMinExp = -\/4;}
\DoxyCodeLine{1095     \textcolor{comment}{// Use digits10 here to increase compatibility with version 2.}}
\DoxyCodeLine{1096     constexpr \textcolor{keywordtype}{int} kMaxExp = std::numeric\_limits<FloatType>::digits10;}
\DoxyCodeLine{1097 }
\DoxyCodeLine{1098     assert(last -\/ first >= kMaxExp + 2);}
\DoxyCodeLine{1099     assert(last -\/ first >= 2 + (-\/kMinExp -\/ 1) + std::numeric\_limits<FloatType>::max\_digits10);}
\DoxyCodeLine{1100     assert(last -\/ first >= std::numeric\_limits<FloatType>::max\_digits10 + 6);}
\DoxyCodeLine{1101 }
\DoxyCodeLine{1102     \textcolor{keywordflow}{return} dtoa\_impl::format\_buffer(first, len, decimal\_exponent, kMinExp, kMaxExp);}
\DoxyCodeLine{1103 \}}
