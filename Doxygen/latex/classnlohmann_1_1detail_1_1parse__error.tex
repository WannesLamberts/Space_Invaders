...
\begin{DoxyCode}{0}
\DoxyCodeLine{130     \{}
\DoxyCodeLine{131         std::string w = exception::name(\textcolor{stringliteral}{"parse\_error"}, id\_) + \textcolor{stringliteral}{"parse error"} +}
\DoxyCodeLine{132                         position\_string(pos) + \textcolor{stringliteral}{": "} + what\_arg;}
\DoxyCodeLine{133         \textcolor{keywordflow}{return} parse\_error(id\_, pos.chars\_read\_total, w.c\_str());}
\DoxyCodeLine{134     \}}
...
\item 
json-\/develop/include/nlohmann/detail/exceptions.\+hpp\item 
