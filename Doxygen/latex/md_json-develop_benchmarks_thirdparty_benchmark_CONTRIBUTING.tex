We\textquotesingle{}d love to accept your patches and contributions to this project. There are a just a few small guidelines you need to follow.\hypertarget{md_json-develop_benchmarks_thirdparty_benchmark_CONTRIBUTING_autotoc_md1}{}\doxysection{Contributor License Agreement}\label{md_json-develop_benchmarks_thirdparty_benchmark_CONTRIBUTING_autotoc_md1}
...
Once your C\+LA is submitted (or if you already submitted one for another Google project), make a commit adding yourself to the \mbox{[}A\+U\+T\+H\+O\+RS\mbox{]}\mbox{[}\mbox{]} and \mbox{[}C\+O\+N\+T\+R\+I\+B\+U\+T\+O\+RS\mbox{]}\mbox{[}\mbox{]} files. This commit can be part of your first \href{https://help.github.com/articles/creating-a-pull-request}{\texttt{ pull request}}.\hypertarget{md_json-develop_benchmarks_thirdparty_benchmark_CONTRIBUTING_autotoc_md2}{}\doxysection{Submitting a patch}\label{md_json-develop_benchmarks_thirdparty_benchmark_CONTRIBUTING_autotoc_md2}
