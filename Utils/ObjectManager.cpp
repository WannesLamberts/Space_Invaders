...
void Utils::ObjectManager::addDeletion(std::shared_ptr<ControllerAbstract> v) { objectsToDelete.push_back(v); }
void Utils::ObjectManager::deleteob(int i) { o.erase(o.begin() + i); }
const std::vector<std::shared_ptr<Utils::Object>>& Utils::ObjectManager::getO() const { return o; }
void Utils::ObjectManager::addObject(std::shared_ptr<Utils::Object> obj) { o.push_back(obj); }
